...
def main(argv):
    ...
    for toplot in ToPlot:
        ...
        sratio,sband,tmp = DrawNiceRatioWithBand(hsig, hdataBgSub, hxmin, hxmax, gyratioMin, gyratioMax, stuff, iplot, 'Pseudo (Data - Bg) / Sig')
        ratios.append(sband)
    ...
    # kill oneself:
    os.system('killall XsectStack.py')
